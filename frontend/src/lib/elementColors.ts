...
export const ELEMENT_META: Record<string, {
  ...
  "火": { emoji: "☀️", label: "火", meaning: "활발한 기운이 가득한 날이에요",   bg: "bg-gradient-to-br from-orange-50 to-red-50",    color: "text-red-500" },
  "水": { emoji: "🌧️", label: "水", meaning: "내면을 돌아보기 좋은 날이에요",   bg: "bg-gradient-to-br from-blue-50 to-sky-50",     color: "text-blue-500" },
  "木": { emoji: "💨", label: "木", meaning: "새로운 시작과 성장의 기운이에요", bg: "bg-gradient-to-br from-green-50 to-emerald-50", color: "text-emerald-600" },
  "金": { emoji: "☁️", label: "金", meaning: "정리하고 결단하기 좋은 날이에요", bg: "bg-gradient-to-br from-slate-50 to-gray-100",   color: "text-slate-500" },
  "土": { emoji: "⛅", label: "土", meaning: "안정과 균형을 찾는 날이에요",     bg: "bg-gradient-to-br from-amber-50 to-yellow-50", color: "text-amber-600" },
};
...
export const FORECAST_LEVEL_META: Record<string, {
  ...
  "주의가 필요한 날": { color: "text-rose-700 bg-rose-50 border-rose-200",           badge: "bg-rose-100 text-rose-800",      icon: "🚨", image: "/kkachi/caution_kkachi.png" },
};
