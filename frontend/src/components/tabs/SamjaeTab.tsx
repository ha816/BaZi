  ...
  return (
    <div className="space-y-4">
      <div className="slide-card">
        <CollapsibleSectionHeader title="삼재(三災)">
          <p>
            12년 주기로 찾아오는 <strong className="text-[var(--color-ink)]">3년간의 액운기</strong>예요. 수재(水災)·화재(火災)·풍재(風災) 세 재앙이 겹친다 하여 삼재라 부르고, 태어난 띠에 따라 시기가 정해져 있어요. 3년은 들삼재(入)→눌삼재(訥)→날삼재(出) 세 단계로 흘러요.
          </p>
        ...
        <div className="slide-card__body space-y-4">
          <KkachiTip>
            삼재는 12년에 한 번 찾아오는 액운 흐름이에요. 하지만 무리하지 않고 결을 따르면 오히려 다음 도약의 발판이 되기도 합니다.
          </KkachiTip>
          ...
          {!showSamjae ? (
            ...
            <>
              {samjae ? (() => {
                ...
                return (
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-center">
                      <Image src="/kkachi/samjae/samjae.png" alt="삼재" width={240} height={240} className="object-cover w-2/3 aspect-[4/3] rounded-xl" />
                    </div>
                    <KkachiTip>
                ...
                <div className="space-y-3">
                  <div className="flex justify-center">
                    <Image src="/kkachi/samjae/no_samjae.png" alt="삼재 없음" width={240} height={240} className="object-cover w-2/3 aspect-[4/3] rounded-xl" />
                  </div>
                  <KkachiTip>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {samjaeCycles[0].map((year) => {
                    ...
                    return (
                      <div
                        key={year}
                        className="flex flex-col items-center gap-1 rounded-lg px-2.5 py-2 border text-center"
                        style={isCurrent
                      ...
                      >
                        <span className="text-[11px] font-bold text-[var(--color-ink)]">
                          {year}년 — {BRANCH_KOR[branch]}년({branch}年)
                          {isCurrent && <span className="ml-1 text-[9px] font-semibold text-[var(--color-gold)]">· 올해</span>}
                        </span>
                        <span
